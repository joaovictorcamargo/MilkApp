...
const Order = ({ navigation, route, appTheme }) => {
    ...
    const [selectedCategory, setSelectedCategory] = useState("MilkTea")
    ...
    useEffect(() => {
       let menuList = dummyData.menuList.filter(menuItem =>
        ...
        return (
            ...
            >
                ...
                containerStyle={{
                    marginTop: 90,
                    width: 100
                }}   selected={selectedCategory == "Specicialthie"}
                onPress={() => setSelectedCategory("Specicialthie")}
                />
